    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="flex items-center justify-center gap-3 mb-10">
          ...
          <span className="text-2xl font-bold text-white tracking-tight">P.F. Chang&apos;s AI</span>
        </div>

        {/* Login Card */}
        <div className="bg-white/[0.05] border border-white/[0.1] rounded-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-white/[0.05] border border-white/[0.1] rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-500/50 focus:border-red-500/50 transition-all"
